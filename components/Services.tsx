...
const services = [
  {
    ...
    body: '63% of product searches start on Amazon — not Google. Every month without a presence is market share handed to your competitors. We take you from zero to a fully live, optimized, and advertising store in 90 days. Done right the first time. Brands that launch correctly report 30–60% revenue uplift within 6 months — brands that launch badly spend that time fixing costly mistakes.',
  ...
  },
  {
    ...
    body: 'Amazon fees now consume 50%+ of revenue for most sellers. PPC is wasting budget on the wrong keywords. Organic rank is stuck. And you don\'t have time to fix it while running a business. We take over the account — PPC, listings, inventory, account health — and turn the dials every single week. Most accounts we audit have 15–25% of ad spend going to zero-converting search terms. That\'s recoverable budget we find in month one.',
  ...
  },
  {
    ...
    body: '68% of Chinese factories were caught substituting materials in 2024. Every batch carries quality risk — and if compromised inventory reaches Amazon\'s warehouse, the damage is catastrophic: negative reviews, A-to-Z claims, and ODR violations that can suspend your account. 35% of Amazon sellers faced suspension in 2024. We inspect, prep, and ship from China — catching problems before they ever leave the source.',
